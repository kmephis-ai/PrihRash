...
Unknown parameter, массив/duplicate-like значение, blank value, malformed UUID/cursor или noncanonical limit блокируются до YDB read. Raw query value не входит в request error message.
