...
Before any provider repair under this contract, the exact Function `prihrash-r1-initial-bootstrap` must contain the private invocation bindings required by the WU7 transport:
