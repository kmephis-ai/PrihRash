...
const ALLOWED_RUNTIME_BASENAMES = new Set([
  ...
  'yandexCloudInitialBootstrapRecoveryFunction.js.map',
  'yandexCloudInitialBootstrapRecoveryFunction.d.ts',
]);

const rootPackage = JSON.parse(await readFile(resolve(ROOT, 'package.json'), 'utf8'));
const runtimePackage = {
  name: 'prihrash-yandex-initial-bootstrap-recovery-function',
