...
const STAGING_CONTROLLED_PREPARATION_QUERY_ERROR_EVIDENCE = new Set([
  'UNOBSERVED',
  'ABORT_TIMEOUT',
  'YDB_STATUS',
  'GRPC_STATUS',
...
const STAGING_CONTROLLED_PREPARATION_GRPC_STATUS_EVIDENCE = new Set([
  'UNOBSERVED',
  'CANCELLED',
  'UNKNOWN',
  'INVALID_ARGUMENT',
...
const STAGING_CONTROLLED_PREPARATION_PHASE_EVIDENCE = new Set([
  'UNOBSERVED',
  'ADMISSION_READ',
...
const STAGING_CONTROLLED_PREPARATION_REFERENCE_READ_STAGE_EVIDENCE = new Set([
  'UNOBSERVED',
  'ACCOUNTS_READ',
  'CATEGORIES_READ',
  'VIKA_MEMBER_READ',
...
const STAGING_CONTROLLED_PREPARATION_METADATA_SCAN_COST_EVIDENCE = new Set([
  'UNOBSERVED',
  'LT_10_RU',
  'GE_10_LT_3000_RU',
  'GE_3000_RU',
...
const STAGING_CONTROLLED_PREPARATION_REVISION_PAYLOAD_BATCH_EVIDENCE = new Set([
  'UNOBSERVED',
  'NO_PAYLOAD_BATCH',
...
function parseExactResult(stdout, surfaceOnly = false, controlledPreparationOnly = false) {
  ...
  if (
    ...
    const stagingControlledPreparationReferenceReadStageEvidence =
      result.stagingControlledPreparationReferenceReadStageEvidence;
    ...
    const stagingControlledPreparationMetadataScanCostEvidence =
    ...
    const validDiagnosticShape = controlledPreparationOnly
      ? result.reason === 'STAGING_RUN_PRESENT'
        ? exactKeys(result, [
          ...
          && typeof stagingControlledPreparationQueryErrorEvidence === 'string'
          && STAGING_CONTROLLED_PREPARATION_QUERY_ERROR_EVIDENCE.has(stagingControlledPreparationQueryErrorEvidence)
          && typeof stagingControlledPreparationGrpcStatusEvidence === 'string'
          ...
          && typeof stagingControlledPreparationReferenceReadStageEvidence === 'string'
          ...
          && typeof stagingControlledPreparationMetadataScanCostEvidence === 'string'
          && STAGING_CONTROLLED_PREPARATION_METADATA_SCAN_COST_EVIDENCE.has(
            stagingControlledPreparationMetadataScanCostEvidence,
          )
          && typeof stagingControlledPreparationRevisionPayloadBatchEvidence === 'string'
    ...
    return Object.freeze({
      ...
      stagingControlledPreparationRetryEvidence: result.reason === 'STAGING_RUN_PRESENT'
        ...
        : null,
      stagingControlledPreparationQueryErrorEvidence: result.reason === 'STAGING_RUN_PRESENT'
        ? stagingControlledPreparationQueryErrorEvidence ?? null
        : null,
      stagingControlledPreparationGrpcStatusEvidence: result.reason === 'STAGING_RUN_PRESENT'
      ...
      stagingControlledPreparationPhaseEvidence: result.reason === 'STAGING_RUN_PRESENT'
        ...
        : null,
      stagingControlledPreparationReferenceReadStageEvidence: result.reason === 'STAGING_RUN_PRESENT'
        ? stagingControlledPreparationReferenceReadStageEvidence ?? null
        : null,
      stagingControlledPreparationReconciliationReadStageEvidence: result.reason === 'STAGING_RUN_PRESENT'
        ...
        : null,
      stagingControlledPreparationMetadataScanCostEvidence: result.reason === 'STAGING_RUN_PRESENT'
...
if (invocation.stagingControlledPreparationQueryErrorEvidence !== null) {
  process.stderr.write(
    `R1_STAGING_CONTROLLED_PREPARATION_QUERY_ERROR_EVIDENCE=${invocation.stagingControlledPreparationQueryErrorEvidence}\n`,
  );
}
if (invocation.stagingControlledPreparationGrpcStatusEvidence !== null) {
  process.stderr.write(
    `R1_STAGING_CONTROLLED_PREPARATION_GRPC_STATUS_EVIDENCE=${invocation.stagingControlledPreparationGrpcStatusEvidence}\n`,
  );
}
...
if (invocation.stagingControlledPreparationReferenceReadStageEvidence !== null) {
  process.stderr.write(
    `R1_STAGING_CONTROLLED_PREPARATION_REFERENCE_READ_STAGE_EVIDENCE=${invocation.stagingControlledPreparationReferenceReadStageEvidence}\n`,
  );
}
...
if (invocation.stagingControlledPreparationMetadataScanCostEvidence !== null) {
  process.stderr.write(
    `R1_STAGING_CONTROLLED_PREPARATION_METADATA_SCAN_COST_EVIDENCE=${invocation.stagingControlledPreparationMetadataScanCostEvidence}\n`,
  );
}
